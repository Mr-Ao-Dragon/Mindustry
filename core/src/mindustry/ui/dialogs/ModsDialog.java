...
public class ModsDialog extends BaseDialog{
    ...
    void getModList(Cons<Seq<ModListing>> listener){
        if(modList == null){
            Http.get("https://raw.githubusercontents.com/Anuken/MindustryMods/master/mods.json", response -> {
                    ...
                    con.add(new BorderImage(){
                        ...
                        public void draw(){
                            ...
                            if(!textureCache.containsKey(repo)){
                                ...
                                Http.get("https://raw.githubusercontents.com/Anuken/MindustryMods/master/icons/" + repo.replace("/", "_"), res -> {
